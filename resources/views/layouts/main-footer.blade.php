    ...
    <div class="grid grid-cols-2 gap-6 mb-10 md:grid-cols-4">
        <div class=" col-span-full lg:col-span-2">
            ...
            <p class="mt-3 text-xs text-gray-600 sm:text-sm dark:text-neutral-400">
                ...
                Lazismu Wilayah DIY. Lazismu UMY siap untuk selalu menjadi LAZIS terbaik di PTMA (Perguruan Tinggi
                Muhammadiyah-Aisyiyah) di seluruh Indonesia.
            </p>
        </div>
        <!-- End Col -->
        ...
        <div>
            ...
            <div class="grid mt-3 space-y-3 text-sm">
                <p><a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
        ...
        <div>
            <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">Alamat</h4>

            <div class="grid mt-3 space-y-3 text-sm">
                <p class="mt-3 text-xs text-gray-600 sm:text-sm dark:text-neutral-400">
                    Kantor Layanan : Masjid K.H Ahmad Dahlan Lantai 1, Komplek Kampus Terpadu Universitas Muhammadiyah
                    Yogyakarta. Jln. Brawijaya Tamantirto Kasihan Bantul, DI Yogyakarta
                </p>
                <p class="mt-3 text-xs text-gray-600 sm:text-sm dark:text-neutral-400">
                    Telp : (0274) 387656
                </p>
        ...
        <div class="sm:flex sm:justify-between sm:items-center">
            <div class="flex flex-wrap items-center gap-3">
                <div class="space-x-4 text-sm">
                    <a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                        href="#">Terms</a>
                    <a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                        href="#">Privacy</a>
                    <a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
